  ...
  return (
    ...
    <div class="wrapper">
        ...
        <section class="now character">
            <div class="block"></div>
            <img src="https://res.cloudinary.com/do44hvboo/image/upload/v1724443303/Oro-2024.jpg" alt=""/><span class="huge-text">臺。。中</span>
            <div class="caption">
        ...
        <section class="past character">
            <div class="block"></div>
            <img src="https://res.cloudinary.com/do44hvboo/image/upload/v1676998500/upload/26-years-old-in-malta-2_jvrjxl.jpg" alt=""/><span class="huge-text">緣。。起</span>
            <div class="caption">
        ...
        <section class="future character">
            <div class="block"></div>
            <img src="https://res.cloudinary.com/do44hvboo/image/upload/v1677001137/upload/malta-story-01_r75l0y.jpg" alt=""/><span class="huge-text">未。。完</span>
            <div class="caption">
