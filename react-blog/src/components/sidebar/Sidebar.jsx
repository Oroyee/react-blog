  ...
  return (
    <div className="sidebar">
        <div className="sidebarItem">
            ...
            Oro，西班牙語為黃金之意，也是一隻會YeeYee叫恐龍的名字，現任職總部位於馬爾他的區塊鏈公司-Chiliz 擔任自動化軟體測試工程師。倒數第二屆基測生因沒考上台中一中鬼轉五專菁英班，曾任職國家中山科學研究院。台灣疫情爆發期間，離開台中反向深入重災區歐洲尋找機會，是個總是自找麻煩卻樂此不疲的奇人。興趣是收集故事，相信文字能夠改變人生。
            </p>
